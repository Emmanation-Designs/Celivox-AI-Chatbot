...
export const AccountModal: React.FC<AccountModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="bg-gray-900 border border-gray-700 rounded-2xl w-full max-w-5xl h-[85vh] shadow-2xl flex overflow-hidden flex-col md:flex-row">
        
        {/* Sidebar Navigation */}
        <div className="md:w-64 bg-gray-800/50 border-r border-gray-700 p-6 flex flex-col gap-2">
        ...
        <div className="flex-1 bg-gray-900 p-8 overflow-y-auto relative">
          <button onClick={onClose} className="absolute top-6 right-6 text-gray-400 hover:text-white z-10 bg-gray-800/50 rounded-full p-1">
            <X size={24} />
          </button>
          ...
          <div className="max-w-2xl mx-auto pb-10">
            ...
            {activeTab === 'overview' && (
              <div className="space-y-8 animate-fade-in">
                <div>
                  ...
                  <p className="text-gray-400">Manage your public profile and security.</p>
                </div>

                <div className="flex items-center gap-6 p-6 bg-gray-800 rounded-xl border border-gray-700">
                ...
                <div className="p-6 bg-gray-800 rounded-xl border border-gray-700 space-y-4">
                   ...
                   <div className="flex gap-4 pt-2">
                      ...
                      <Button variant="secondary" onClick={handlePasswordReset} isLoading={loading}>Reset Password</Button>
                   </div>
                </div>
              </div>
            )}
            ...
            {activeTab === 'subscription' && (
              <div className="space-y-8 animate-fade-in">
                <div>
                  <h3 className="text-2xl font-bold text-white mb-1">Subscription & Limits</h3>
                  <p className="text-gray-400">Manage your plan and check daily usage.</p>
                </div>

                {/* Current Plan Card */}
                <div className="p-6 bg-gradient-to-r from-gray-800 to-gray-800/50 border border-gray-700 rounded-xl relative overflow-hidden">
                  <div className="relative z-10 flex justify-between items-start">
                    <div>
                      <div className="text-sm text-gray-400 uppercase tracking-wider font-semibold mb-1">Current Plan</div>
                    ...
                    {!isPremium && (
                      <Button onClick={onUpgrade} className="bg-gradient-to-r from-blue-600 to-purple-600 border-0">
                        Upgrade Now
                      </Button>
                    )}
                  </div>
                  {isPremium && (
                     <div className="absolute -right-10 -bottom-10 text-yellow-500/10 transform rotate-12">
                        <Zap size={200} />
                     </div>
                  )}
                </div>
            ...
            {activeTab === 'settings' && (
               <div className="space-y-8 animate-fade-in pb-10">
                 <div>
                   <h3 className="text-2xl font-bold text-white mb-1">App Settings</h3>
                   <p className="text-gray-400">Customize your Celivox experience.</p>
                 </div>

                 <div className="space-y-4">
                    <div className="p-6 bg-gray-800 rounded-xl border border-gray-700 space-y-6">
                       {/* VOICE SETTINGS - MOVED TO TOP */}
                       <div className="space-y-3">
                         <label className="font-medium text-white flex items-center gap-2 text-lg">
                            <Mic size={20} className="text-blue-400"/> AI Voice Selection
                         </label>
                       ...
                       <div className="border-t border-gray-700 pt-6 space-y-3">
                         <label className="block font-medium text-white text-lg">AI Personality</label>
                         <select 
                           value={personality}
                         ...
                         <p className="text-xs text-gray-500">Changes how the AI responds to your queries.</p>
                       </div>
                    </div>

                    <div className="p-4 bg-gray-800 rounded-xl border border-gray-700 flex items-center justify-between">
                       <div className="flex items-center gap-3">
                          {isDarkMode ? <Moon className="text-purple-400" /> : <Sun className="text-yellow-400" />}
                          <div>
                            <div className="font-medium text-white">Dark Mode</div>
                            <div className="text-xs text-gray-400">Adjust the application appearance</div>
                          </div>
                       </div>
                       <button 
                         onClick={toggleTheme}
                 ...
                 <div className="mt-8 p-6 bg-gray-800 rounded-xl border border-gray-700 space-y-6 relative overflow-hidden">
                    ...
                    <div className="p-3 bg-gray-900/80 rounded-lg border border-gray-700 text-xs text-gray-400">
                      <strong className="text-gray-300 block mb-1">Free Daily Limits</strong>
                      50 messages | 7 images | 5 file analyses
                    </div>
            ...
            {activeTab === 'danger' && (
               <div className="space-y-8 animate-fade-in">
                 <div>
                   <h3 className="text-2xl font-bold text-red-500 mb-1">Data & Privacy</h3>
                   <p className="text-gray-400">Manage your data and account existence.</p>
                 </div>
                 ...
                 <div className="space-y-4">
                    ...
                    <div className="p-4 bg-gray-800 rounded-xl border border-gray-700 flex items-center justify-between">
                       ...
                       <Button variant="danger" onClick={handleClearMemoryAction}>Clear All</Button>
                    </div>
